...
public class friend_cusstom_activity extends ArrayAdapter {
    Activity activity;
    ArrayList arrayList;
    FirebaseAuth mauth;
    ...
    TextView textView;
    String uid;
    public friend_cusstom_activity(Activity activity,ArrayList arrayList)
    {
        super(activity,R.layout.custom_friend,arrayList);
    ...
    public View getView(int position, @NonNull View convertView, @NonNull ViewGroup parent) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_friend,null);
